            ...
            <div class="col-9">
                ...
                <form action="" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="campoNome" id="idNome" placeholder="">
                    </div>
                    <div class="mb-3">
                        <label for="idValor" class="form-label">Valor:</label>
                        <input type="text" class="form-control" name="campoValor" id="idValor" placeholder="">
                    </div>
                    <div class="mb-3">
                        <label for="idCodigo" class="form-label">Código:</label>
                        <input type="text" class="form-control" name="campoCodigo" id="idCodigo" placeholder="">
                    </div>
                    <div class="mb-3">
                        <label for="idQuantidade" class="form-label">Quantidade:</label>
                        <input type="number" class="form-control" name="campoQuantidade" id="idQuantidade" placeholder="">
                    </div>                    
                    <div class="mt-3 mb-3">
